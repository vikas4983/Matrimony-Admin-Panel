...
<div class="content-wrapper">
    <div class="content">
        ...
        <div class="card card-default">
                ...
                <div class="card-header">
                    <div class="btn-group mb-1">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{ route('educations.index') }}">View Employee Type</a>
            ...
            {{-- <div class="card card-default">
                <div class="card-header">
                    <a button href="{{ route('educations.index') }}" type="button" class="btn btn-primary">View Employee
            Type</button></a>
